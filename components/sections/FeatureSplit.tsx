...
export default function FeatureSplit({
  ...
  return (
    <section aria-labelledby={headingId} className='bg-white py-12 lg:py-16'>
      <Container className='flex flex-col gap-8 lg:flex-row lg:items-center lg:gap-24'>
        <div
          className={`w-full lg:flex-1 ${imageFirst ? 'lg:order-2' : 'lg:order-1'}`}
        >
          <h2
            id={headingId}
        ...
        <div
          className={`w-full lg:w-150 lg:shrink-0 ${imageFirst ? 'lg:order-1' : 'lg:order-2'}`}
        >
          <Image
