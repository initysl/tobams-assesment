...
const SOCIALS = [
  {
    label: 'Tobams Group on LinkedIn',
    href: 'https://www.linkedin.com/company/tobams-group',
    Icon: LinkedInIcon,
  },
  {
    label: 'Tobams Group on Instagram',
    href: 'https://instagram.com/tobamsgroup',
    Icon: InstagramIcon,
  },
  {
    label: 'Tobams Group on X',
    href: 'https://x.com/Tobams_group',
    Icon: XIcon,
  },
];
